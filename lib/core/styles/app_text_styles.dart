...
class AppTextStyles {
  ...
  // Text captionB() =>
  //     _font(fontWeight: AppFonts.bold, fontSize: AppFonts.caption);
  // Text captionSB() =>
  //     _font(fontWeight: AppFonts.semiBold, fontSize: AppFonts.caption);
  // Text captionM() =>
  //     _font(fontWeight: AppFonts.medium, fontSize: AppFonts.caption);
  // Text captionR() =>
  //     _font(fontWeight: AppFonts.regular, fontSize: AppFonts.caption);

  // Text overlineB() =>
  //     _font(fontWeight: AppFonts.bold, fontSize: AppFonts.overline);
  // Text overlineSB() =>
  //     _font(fontWeight: AppFonts.semiBold, fontSize: AppFonts.overline);
  // Text overlineM() =>
  //     _font(fontWeight: AppFonts.medium, fontSize: AppFonts.overline);
  // Text overlineR() =>
  //     _font(fontWeight: AppFonts.regular, fontSize: AppFonts.overline);

  Text size13M() =>
      _font(fontWeight: AppFonts.medium, fontSize: AppFonts.size13);

  // Text tinyB() => _font(fontWeight: AppFonts.bold, fontSize: AppFonts.tiny);
  // Text tinySB() =>
  //     _font(fontWeight: AppFonts.semiBold, fontSize: AppFonts.tiny);
  // Text tinyM() => _font(fontWeight: AppFonts.medium, fontSize: AppFonts.tiny);
  // Text tinyR() => _font(fontWeight: AppFonts.regular, fontSize: AppFonts.tiny);
}
